...
public class BuffMobsConfig {
    ...
    public static class DimensionMaxHealth {
        public boolean enabled = false;
        public DimensionMaxHealthSlot slot1 = new DimensionMaxHealthSlot();
        public DimensionMaxHealthSlot slot2 = new DimensionMaxHealthSlot();
        public DimensionMaxHealthSlot slot3 = new DimensionMaxHealthSlot();
        public DimensionMaxHealthSlot slot4 = new DimensionMaxHealthSlot();
        public DimensionMaxHealthSlot slot5 = new DimensionMaxHealthSlot();

        public static class DimensionMaxHealthSlot {

...
public class ClothConfigScreen {
    ...
    public static Screen create(Screen parent) {
        ...
        ConfigCategory main = builder.getOrCreateCategory(Component.translatable("buffmobs.config.general"));

        main.addEntry(eb.startBooleanToggle(Component.translatable("buffmobs.config.general.enabled"), cfg.enabled.get())
                .setDefaultValue(true)
                .setTooltip(tt("buffmobs.config.general.enabled.tooltip"))
                .setSaveConsumer(cfg.enabled::set).build());
        main.addEntry(eb.startBooleanToggle(Component.translatable("buffmobs.config.general.visualEffects"), cfg.visualEffects.get())
                .setDefaultValue(true)
        ...
        dimMaxHealthSub.add(eb.startBooleanToggle(Component.translatable("buffmobs.config.dimensionMaxHealth.enabled"), cfg.dimensionMaxHealth.enabled.get())
                .setDefaultValue(false)
        ...
        for (int i = 0; i < maxHealthSlots.length; i++) {
            ...
            var maxHealthFilterSub = eb.startSubCategory(Component.translatable("buffmobs.config.dimensionMaxHealth.mobFilter"));
            maxHealthFilterSub.add(eb.startBooleanToggle(Component.translatable("buffmobs.config.dimensionMaxHealth.useAllowlist"), slot.useAllowlist.get())
                    .setDefaultValue(false)
                    .setTooltip(tt("buffmobs.config.dimensionMaxHealth.useAllowlist.tooltip"))
                    .setSaveConsumer(slot.useAllowlist::set).build());
            maxHealthFilterSub.add(eb.startStrList(Component.translatable("buffmobs.config.dimensionMaxHealth.allowlist"), new ArrayList<>(slot.allowlist.get()))
                    .setDefaultValue(new ArrayList<>())
                    .setTooltip(tt("buffmobs.config.dimensionMaxHealth.allowlist.tooltip"))
                    .setSaveConsumer(v -> slot.allowlist.set(v)).build());
            maxHealthFilterSub.add(eb.startStrList(Component.translatable("buffmobs.config.dimensionMaxHealth.denylist"), new ArrayList<>(slot.denylist.get()))
                    .setDefaultValue(new ArrayList<>())
                    .setTooltip(tt("buffmobs.config.dimensionMaxHealth.denylist.tooltip"))
                    .setSaveConsumer(v -> slot.denylist.set(v)).build());
            slotSub.add(maxHealthFilterSub.build());

            dimMaxHealthSub.add(slotSub.build());
        }
        ...
        main.addEntry(eb.startTextDescription(Component.translatable("buffmobs.config.credits.translation")).build());

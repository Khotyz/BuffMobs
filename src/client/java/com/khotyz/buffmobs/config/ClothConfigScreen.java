...
public class ClothConfigScreen {
    ...
    public static Screen create(Screen parent) {
        ...
        ConfigCategory attributesCat = builder.getOrCreateCategory(Component.translatable("buffmobs.config.attributes"));
        attributesCat.addEntry(eb.startDoubleField(Component.translatable("buffmobs.config.attributes.healthMultiplier"), cfg.attributes.healthMultiplier)
        ...
        attributesCat.addEntry(eb.startDoubleField(Component.translatable("buffmobs.config.attributes.damageMultiplier"), cfg.attributes.damageMultiplier)
                .setDefaultValue(1.5).setMin(0.1)
        ...
        attributesCat.addEntry(eb.startDoubleField(Component.translatable("buffmobs.config.attributes.speedMultiplier"), cfg.attributes.speedMultiplier)
        ...
        attributesCat.addEntry(eb.startDoubleField(Component.translatable("buffmobs.config.attributes.attackSpeedMultiplier"), cfg.attributes.attackSpeedMultiplier)
                .setDefaultValue(1.0).setMin(0.1)
        ...
        attributesCat.addEntry(eb.startDoubleField(Component.translatable("buffmobs.config.attributes.armorAddition"), cfg.attributes.armorAddition)
        ...
        attributesCat.addEntry(eb.startDoubleField(Component.translatable("buffmobs.config.attributes.armorToughnessAddition"), cfg.attributes.armorToughnessAddition)
        ...
        ConfigCategory effectsCat = builder.getOrCreateCategory(Component.translatable("buffmobs.config.effects"));
        effectsCat.addEntry(eb.startIntField(Component.translatable("buffmobs.config.effects.duration"), cfg.effects.duration)
        ...
        effectsCat.addEntry(eb.startIntSlider(Component.translatable("buffmobs.config.effects.strengthAmplifier"), cfg.effects.strengthAmplifier, 0, 10)
                .setDefaultValue(0)
                .setTextGetter(v -> v == 0
        ...
        effectsCat.addEntry(eb.startIntSlider(Component.translatable("buffmobs.config.effects.speedAmplifier"), cfg.effects.speedAmplifier, 0, 10)
                .setDefaultValue(0)
                .setTextGetter(v -> v == 0
                        ? Component.translatable("buffmobs.config.effects.slider.disabled")
                        : Component.translatable("buffmobs.config.effects.slider.level", v))
        ...
        effectsCat.addEntry(eb.startIntSlider(Component.translatable("buffmobs.config.effects.resistanceAmplifier"), cfg.effects.resistanceAmplifier, 0, 10)
                .setDefaultValue(0)
                .setTextGetter(v -> v == 0
                        ? Component.translatable("buffmobs.config.effects.slider.disabled")
                        : Component.translatable("buffmobs.config.effects.slider.level", v))
        ...
        effectsCat.addEntry(eb.startIntSlider(Component.translatable("buffmobs.config.effects.regenerationAmplifier"), cfg.effects.regenerationAmplifier, 0, 10)
                .setDefaultValue(0)
                .setTextGetter(v -> v == 0
                        ? Component.translatable("buffmobs.config.effects.slider.disabled")
                        : Component.translatable("buffmobs.config.effects.slider.level", v))
        ...
        effectsCat.addEntry(eb.startIntSlider(Component.translatable("buffmobs.config.effects.absorptionAmplifier"), cfg.effects.absorptionAmplifier, 0, 10)
                .setDefaultValue(0)
                .setTextGetter(v -> v == 0
                        ? Component.translatable("buffmobs.config.effects.slider.disabled")
                        : Component.translatable("buffmobs.config.effects.slider.level", v))
        ...
        ConfigCategory harmfulCat = builder.getOrCreateCategory(Component.translatable("buffmobs.config.harmfulEffects"));
        harmfulCat.addEntry(eb.startBooleanToggle(Component.translatable("buffmobs.config.harmfulEffects.enabled"), cfg.harmfulEffects.enabled)
                .setDefaultValue(true)
                .setTooltip(tt("buffmobs.config.harmfulEffects.enabled.tooltip"))
                .setSaveConsumer(v -> cfg.harmfulEffects.enabled = v).build());
        harmfulCat.addEntry(eb.startDoubleField(Component.translatable("buffmobs.config.harmfulEffects.chance"), cfg.harmfulEffects.chance)
        ...
        harmfulCat.addEntry(eb.startIntField(Component.translatable("buffmobs.config.harmfulEffects.poisonDuration"), cfg.harmfulEffects.poisonDuration)
        ...
        harmfulCat.addEntry(eb.startIntField(Component.translatable("buffmobs.config.harmfulEffects.slownessDuration"), cfg.harmfulEffects.slownessDuration)
        ...
        harmfulCat.addEntry(eb.startIntField(Component.translatable("buffmobs.config.harmfulEffects.witherDuration"), cfg.harmfulEffects.witherDuration)
                .setDefaultValue(3).setMin(1).setMax(60)
        ...
        ConfigCategory dayScalingCat = builder.getOrCreateCategory(Component.translatable("buffmobs.config.dayScaling"));
        dayScalingCat.addEntry(eb.startBooleanToggle(Component.translatable("buffmobs.config.dayScaling.enabled"), cfg.dayScaling.enabled)
                .setDefaultValue(false)
                .setTooltip(tt("buffmobs.config.dayScaling.enabled.tooltip"))
                .setSaveConsumer(v -> cfg.dayScaling.enabled = v).build());
        dayScalingCat.addEntry(eb.startIntField(Component.translatable("buffmobs.config.dayScaling.interval"), cfg.dayScaling.interval)
        ...
        dayScalingCat.addEntry(eb.startDoubleField(Component.translatable("buffmobs.config.dayScaling.multiplier"), cfg.dayScaling.multiplier)
        ...
        dayScalingCat.addEntry(eb.startDoubleField(Component.translatable("buffmobs.config.dayScaling.maxMultiplier"), cfg.dayScaling.maxMultiplier)
                .setDefaultValue(5.0).setMin(0.0)
                .setTooltip(tt("buffmobs.config.dayScaling.maxMultiplier.tooltip"))
                .setSaveConsumer(v -> cfg.dayScaling.maxMultiplier = v).build());
        dayScalingCat.addEntry(eb.startBooleanToggle(Component.translatable("buffmobs.config.dayScaling.showNotifications"), cfg.dayScaling.showNotifications)
                .setDefaultValue(true)
        ...
        dayScalingCat.addEntry(eb.startEnumSelector(Component.translatable("buffmobs.config.dayScaling.notificationMode"),
        ...
        ConfigCategory zombieHandlingCat = builder.getOrCreateCategory(Component.translatable("buffmobs.config.zombieHandling"));
        zombieHandlingCat.addEntry(eb.startBooleanToggle(Component.translatable("buffmobs.config.zombieHandling.disableLeaderZombies"), cfg.zombieHandling.disableLeaderZombies)
                .setDefaultValue(false)
        ...
        zombieHandlingCat.addEntry(eb.startBooleanToggle(Component.translatable("buffmobs.config.zombieHandling.excludeLeaderBonusFromMultiplier"), cfg.zombieHandling.excludeLeaderBonusFromMultiplier)
                .setDefaultValue(false)
        ...
        ConfigCategory healthSyncCat = builder.getOrCreateCategory(Component.translatable("buffmobs.config.healthSync"));
        healthSyncCat.addEntry(eb.startBooleanToggle(Component.translatable("buffmobs.config.healthSync.enabled"), cfg.healthSync.enabled)
                .setDefaultValue(true)
                .setTooltip(tt("buffmobs.config.healthSync.enabled.tooltip"))
                .setSaveConsumer(v -> cfg.healthSync.enabled = v).build());
        healthSyncCat.addEntry(eb.startEnumSelector(Component.translatable("buffmobs.config.healthSync.mode"),
        ...
        ConfigCategory dimScalingCat = builder.getOrCreateCategory(Component.translatable("buffmobs.config.dimensionScaling"));
        dimScalingCat.addEntry(eb.startEnumSelector(Component.translatable("buffmobs.config.dimensionScaling.mode"),
                        BuffMobsConfig.DimensionScaling.Mode.class,
                        cfg.dimensionScaling.mode)
                .setDefaultValue(BuffMobsConfig.DimensionScaling.Mode.SCALING)
                .setEnumNameProvider(e -> switch ((BuffMobsConfig.DimensionScaling.Mode) e) {
        ...
        for (int i = 0; i < dimSlots.length; i++) {
            ...
            dimScalingCat.addEntry(slotSub.build());
        }

        ConfigCategory dimMaxHealthCat = builder.getOrCreateCategory(Component.translatable("buffmobs.config.dimensionMaxHealth"));
        dimMaxHealthCat.addEntry(eb.startBooleanToggle(Component.translatable("buffmobs.config.dimensionMaxHealth.enabled"), cfg.dimensionMaxHealth.enabled)
                .setDefaultValue(false)
                .setTooltip(tt("buffmobs.config.dimensionMaxHealth.enabled.tooltip"))
                .setSaveConsumer(v -> cfg.dimensionMaxHealth.enabled = v).build());
        BuffMobsConfig.DimensionMaxHealth.DimensionMaxHealthSlot[] dmhSlots = {
        ...
        for (int i = 0; i < dmhSlots.length; i++) {
            BuffMobsConfig.DimensionMaxHealth.DimensionMaxHealthSlot s = dmhSlots[i];
            int n = i + 1;
            ...
            slotSub.add(eb.startTextDescription(tt("buffmobs.config.dimensionMaxHealth.mobFilter")).build());
            slotSub.add(eb.startBooleanToggle(Component.translatable("buffmobs.config.dimensionMaxHealth.useAllowlist"), s.useAllowlist)
                    .setDefaultValue(false)
                    .setTooltip(tt("buffmobs.config.dimensionMaxHealth.useAllowlist.tooltip"))
                    .setSaveConsumer(v -> s.useAllowlist = v).build());
            slotSub.add(eb.startStrList(Component.translatable("buffmobs.config.dimensionMaxHealth.allowlist"), new ArrayList<>(s.allowlist))
                    .setDefaultValue(new ArrayList<>())
                    .setTooltip(tt("buffmobs.config.dimensionMaxHealth.allowlist.tooltip"))
                    .setSaveConsumer(v -> s.allowlist = v).build());
            slotSub.add(eb.startStrList(Component.translatable("buffmobs.config.dimensionMaxHealth.denylist"), new ArrayList<>(s.denylist))
                    .setDefaultValue(new ArrayList<>())
                    .setTooltip(tt("buffmobs.config.dimensionMaxHealth.denylist.tooltip"))
                    .setSaveConsumer(v -> s.denylist = v).build());
            dimMaxHealthCat.addEntry(slotSub.build());
        }

        ConfigCategory mobFilterCat = builder.getOrCreateCategory(Component.translatable("buffmobs.config.mobFilter"));
        mobFilterCat.addEntry(eb.startBooleanToggle(Component.translatable("buffmobs.config.mobFilter.useWhitelist"), cfg.mobFilter.useWhitelist)
                .setDefaultValue(false)
                .setTooltip(tt("buffmobs.config.mobFilter.useWhitelist.tooltip"))
                .setSaveConsumer(v -> cfg.mobFilter.useWhitelist = v).build());
        mobFilterCat.addEntry(eb.startStrList(Component.translatable("buffmobs.config.mobFilter.whitelist"), new ArrayList<>(cfg.mobFilter.whitelist))
                .setDefaultValue(new ArrayList<>())
                .setTooltip(tt("buffmobs.config.mobFilter.whitelist.tooltip"))
                .setSaveConsumer(v -> cfg.mobFilter.whitelist = v).build());
        mobFilterCat.addEntry(eb.startStrList(Component.translatable("buffmobs.config.mobFilter.blacklist"), new ArrayList<>(cfg.mobFilter.blacklist))
        ...
        ConfigCategory modFilterCat = builder.getOrCreateCategory(Component.translatable("buffmobs.config.modidFilter"));
        modFilterCat.addEntry(eb.startBooleanToggle(Component.translatable("buffmobs.config.modidFilter.useWhitelist"), cfg.modidFilter.useWhitelist)
                .setDefaultValue(false)
                .setTooltip(tt("buffmobs.config.modidFilter.useWhitelist.tooltip"))
                .setSaveConsumer(v -> cfg.modidFilter.useWhitelist = v).build());
        modFilterCat.addEntry(eb.startStrList(Component.translatable("buffmobs.config.modidFilter.whitelist"), new ArrayList<>(cfg.modidFilter.whitelist))
                .setDefaultValue(new ArrayList<>())
                .setTooltip(tt("buffmobs.config.modidFilter.whitelist.tooltip"))
                .setSaveConsumer(v -> cfg.modidFilter.whitelist = v).build());
        modFilterCat.addEntry(eb.startStrList(Component.translatable("buffmobs.config.modidFilter.blacklist"), new ArrayList<>(cfg.modidFilter.blacklist))
                .setDefaultValue(new ArrayList<>())
                .setTooltip(tt("buffmobs.config.modidFilter.blacklist.tooltip"))
                .setSaveConsumer(v -> cfg.modidFilter.blacklist = v).build());

        ConfigCategory dimFilterCat = builder.getOrCreateCategory(Component.translatable("buffmobs.config.dimensionFilter"));
        dimFilterCat.addEntry(eb.startBooleanToggle(Component.translatable("buffmobs.config.dimensionFilter.useWhitelist"), cfg.dimensionFilter.useWhitelist)
                .setDefaultValue(false)
        ...
        dimFilterCat.addEntry(eb.startStrList(Component.translatable("buffmobs.config.dimensionFilter.whitelist"), new ArrayList<>(cfg.dimensionFilter.whitelist))
        ...
        dimFilterCat.addEntry(eb.startStrList(Component.translatable("buffmobs.config.dimensionFilter.blacklist"), new ArrayList<>(cfg.dimensionFilter.blacklist))
                .setDefaultValue(new ArrayList<>())
                .setTooltip(tt("buffmobs.config.dimensionFilter.blacklist.tooltip"))
                .setSaveConsumer(v -> cfg.dimensionFilter.blacklist = v).build());

        ConfigCategory rangedCat = builder.getOrCreateCategory(Component.translatable("buffmobs.config.rangedMeleeSwitching"));
        rangedCat.addEntry(eb.startBooleanToggle(Component.translatable("buffmobs.config.rangedMeleeSwitching.enabled"), cfg.rangedMeleeSwitching.enabled)
                .setDefaultValue(true)
        ...
        rangedCat.addEntry(eb.startEnumSelector(Component.translatable("buffmobs.config.rangedMeleeSwitching.behaviorMode"),
        ...
        rangedCat.addEntry(eb.startDoubleField(Component.translatable("buffmobs.config.rangedMeleeSwitching.switchDistance"), cfg.rangedMeleeSwitching.switchDistance)
        ...
        rangedCat.addEntry(eb.startDoubleField(Component.translatable("buffmobs.config.rangedMeleeSwitching.meleeSpeedMultiplier"), cfg.rangedMeleeSwitching.meleeSpeedMultiplier)
        ...
        rangedCat.addEntry(eb.startStrList(Component.translatable("buffmobs.config.rangedMeleeSwitching.customRangedMobs"), new ArrayList<>(cfg.rangedMeleeSwitching.customRangedMobs))
                .setDefaultValue(new ArrayList<>())
        ...
        rangedCat.addEntry(weaponSub.build());
        ...
        rangedCat.addEntry(enchantSub.build());

        ConfigCategory draftCat = builder.getOrCreateCategory(Component.translatable("buffmobs.config.combatDraft"));
        draftCat.addEntry(eb.startBooleanToggle(Component.translatable("buffmobs.config.combatDraft.enabled"), cfg.combatDraft.enabled)
                .setDefaultValue(true)
                .setTooltip(tt("buffmobs.config.combatDraft.enabled.tooltip"))
                .setSaveConsumer(v -> cfg.combatDraft.enabled = v).build());
        draftCat.addEntry(eb.startDoubleField(Component.translatable("buffmobs.config.combatDraft.healthThreshold"), cfg.combatDraft.healthThreshold)
        ...
        draftCat.addEntry(eb.startIntSlider(Component.translatable("buffmobs.config.combatDraft.regenAmplifier"), cfg.combatDraft.regenAmplifier, 1, 10)
                .setDefaultValue(4)
        ...
        draftCat.addEntry(eb.startIntField(Component.translatable("buffmobs.config.combatDraft.regenDuration"), cfg.combatDraft.regenDuration)
        ...
        draftCat.addEntry(eb.startIntField(Component.translatable("buffmobs.config.combatDraft.cooldownTicks"), cfg.combatDraft.cooldownTicks)
        ...
        draftCat.addEntry(eb.startIntField(Component.translatable("buffmobs.config.combatDraft.maxUses"), cfg.combatDraft.maxUses)
        ...
        draftCat.addEntry(draftFilterSub.build());

        ConfigCategory presetsCat = builder.getOrCreateCategory(Component.translatable("buffmobs.config.mobPresets"));
        presetsCat.addEntry(eb.startBooleanToggle(Component.translatable("buffmobs.config.mobPresets.enabled"), cfg.mobPresets.enabled)
                .setDefaultValue(false)
                .setTooltip(tt("buffmobs.config.mobPresets.enabled.tooltip"))
                .setSaveConsumer(v -> cfg.mobPresets.enabled = v).build());
        presetsCat.addEntry(eb.startBooleanToggle(Component.translatable("buffmobs.config.mobPresets.overrideDimensionScaling"), cfg.mobPresets.overrideDimensionScaling)
                .setDefaultValue(false)
        ...
        for (int i = 0; i < presetSlots.length; i++) {
            ...
            presetsCat.addEntry(pSub.build());
        }
        presetsCat.addEntry(eb.startStrList(Component.translatable("buffmobs.config.mobPresets.mobMapping"), new ArrayList<>(cfg.mobPresets.mobMapping))
        ...
        ConfigCategory passiveCat = builder.getOrCreateCategory(Component.translatable("buffmobs.config.passiveMobAggression"));
        passiveCat.addEntry(eb.startEnumSelector(Component.translatable("buffmobs.config.passiveMobAggression.mode"),
                        BuffMobsConfig.PassiveMobAggression.Mode.class,
                        cfg.passiveMobAggression.mode)
                .setDefaultValue(BuffMobsConfig.PassiveMobAggression.Mode.OFF)
                .setEnumNameProvider(e -> switch ((BuffMobsConfig.PassiveMobAggression.Mode) e) {
        ...
        passiveCat.addEntry(eb.startDoubleField(Component.translatable("buffmobs.config.passiveMobAggression.baseDamage"), cfg.passiveMobAggression.baseDamage)
        ...
        passiveCat.addEntry(eb.startBooleanToggle(Component.translatable("buffmobs.config.passiveMobAggression.scaleWithHealth"), cfg.passiveMobAggression.scaleWithHealth)
                .setDefaultValue(false)
        ...
        passiveCat.addEntry(eb.startDoubleField(Component.translatable("buffmobs.config.passiveMobAggression.healthScaleFactor"), cfg.passiveMobAggression.healthScaleFactor)
        ...
        passiveCat.addEntry(eb.startStrList(Component.translatable("buffmobs.config.passiveMobAggression.whitelist"), new ArrayList<>(cfg.passiveMobAggression.whitelist))
                .setDefaultValue(new ArrayList<>())
        ...
        passiveCat.addEntry(eb.startStrList(Component.translatable("buffmobs.config.passiveMobAggression.blacklist"), new ArrayList<>(cfg.passiveMobAggression.blacklist))
                .setDefaultValue(new ArrayList<>())

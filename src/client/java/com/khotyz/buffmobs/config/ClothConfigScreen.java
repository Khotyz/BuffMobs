...
public class ClothConfigScreen {
    ...
    public static Screen create(Screen parent) {
        ...
        ConfigCategory passive = builder.getOrCreateCategory(Component.translatable("buffmobs.config.passiveMobAggression"));
        passive.addEntry(eb.startBooleanToggle(Component.translatable("buffmobs.config.passiveMobAggression.enabled"), cfg.passiveMobAggression.enabled)
                .setDefaultValue(false)
        ...
        passive.addEntry(eb.startDoubleField(Component.translatable("buffmobs.config.passiveMobAggression.baseDamage"), cfg.passiveMobAggression.baseDamage)
        ...
        passive.addEntry(eb.startBooleanToggle(Component.translatable("buffmobs.config.passiveMobAggression.scaleWithHealth"), cfg.passiveMobAggression.scaleWithHealth)
                .setDefaultValue(false)
        ...
        passive.addEntry(eb.startDoubleField(Component.translatable("buffmobs.config.passiveMobAggression.healthScaleFactor"), cfg.passiveMobAggression.healthScaleFactor)
        ...
        passive.addEntry(eb.startStrList(Component.translatable("buffmobs.config.passiveMobAggression.whitelist"), new ArrayList<>(cfg.passiveMobAggression.whitelist))
                .setDefaultValue(new ArrayList<>())
        ...
        passive.addEntry(eb.startStrList(Component.translatable("buffmobs.config.passiveMobAggression.blacklist"), new ArrayList<>(cfg.passiveMobAggression.blacklist))
                .setDefaultValue(new ArrayList<>())
